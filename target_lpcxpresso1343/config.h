...
#define	X_STEP_PIN						PIN_DEF (PIO_1, 10) /* PH1 */
#define	X_DIR_PIN						PIN_DEF (PIO_1, 11) /* PH2 */
#define X_I01_PIN						PIN_DEF (PIO_2, 3) /* I01 */
#define X_I11_PIN						PIN_DEF (PIO_2, 4) /* I11 */
#define X_I02_PIN						PIN_DEF (PIO_2, 5) /* I02 */
#define X_I12_PIN						PIN_DEF (PIO_2, 6) /* I12 */
// #define	X_MIN_PIN						PIN_DEF (PIO_2, 3)
...
#if 0
/* 3.0, 0.10, 0.6, 1.8, 1.5, 2.2 */
#define	Z_STEP_PIN						PIN_DEF (PIO_0, 1)
#define	Z_DIR_PIN							PIN_DEF (PIO_0, 2)
...
DEFINE_HEATER(extruder, PIN_DEF(PIO_0, 7),   0,    1)
DEFINE_HEATER(bed,      PIN_DEF(PIO_2, 0),   0,    1)
